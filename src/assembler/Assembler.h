...
// Pre-processor directives...
    ...
    // Includes...
        ...
        // Both lower level C string processing and higher level C++...
        #include <cstring>
        #include <string>
...
namespace Agni
{
    ...
    class Assembler
    {
        ...
        public:
            ...
            // Constructor...
            Assembler(Parameters &_UserParameters);
        ...
        protected:
            ...
            // Instruction management...
                ...
                int AddInstruction(const char *pszMnemonic, 
                                   uint16 usOperationCode,
                                   uint8 OperandCount);

                // Get instruction by mnemonic...
                boolean GetInstructionByMnemonic(
                ...
                void SetOperandType(uint16 usInstructionIndex, 
                                    uint8 OperandIndex,
                                    AA_OperandType Type);
            ...
            // Function management...
                ...
                int AddFunction(const char *pszName, 
                                uint32 unEntryPoint);
                ...
                void SetFunctionInfo(const char *pszName, 
                                     uint8 ParameterCount,
                                     uint32 unLocalDataSize);
            ...
            // Label management...
                ...
                int AddLabel(const char *pszIdentifier, 
                             uint32 unTargetIndex,
                             uint32 unFunctionIndex);

                // Get a label by identifier...
                AA_LabelNodeData *GetLabelByIdentifier(
            ...
            // String management...
                ...
                uint32 AddString(AA_LinkedList *pList, 
                                 const char *pszString);

            // Symbol management...

                // Add symbol, or -1 on error...
                int AddSymbol(const char *pszIdentifier, 
                              uint32 unSize,
                              int nStackIndex, 
                              uint32 unFunctionIndex);
                ...
                AA_SymbolNodeData *GetSymbolByIdentifier(
                    const char *pszIdentifier,
                    uint32 unFunctionIndex) const;
